...
B_API b8 input_is_key_down(keys key);
B_API b8 input_is_key_up(keys key);
B_API b8 input_was_key_down(keys key);
B_API b8 input_was_key_down(keys key);

void input_process_key(keys key, b8 pressed);

B_API b8 input_is_button_down(buttons button);
B_API b8 input_is_button_up(buttons button);
B_API b8 input_was_button_down(buttons button);
B_API b8 input_was_button_up(buttons button);
B_API void input_get_mouse_position(i32 * x, i32 * y);
B_API void input_get_previous_mouse_position(i32 * x, i32 * y);
